...
func (r *RpcGenerator) generateService(g *protogen.GeneratedFile, file *RpcFile) {
	...
	for method, v2 := range file.Methods {
...
func (r *RpcGenerator) generateMethodHandler(g *protogen.GeneratedFile, file *RpcFile) {
	for method, v2 := range file.Methods {
		g.P("func _", file.ServiceName, "_", method, "_Handler(srv any, ctx ", contextPackage.Ident("Context"), ", in ", protoPackage.Ident("Message"), ") (any, error) {")
		g.P("req := in.(*", v2[0], ")")
...
func GenerateGrpcFile(gen *protogen.Plugin, file *protogen.File) *protogen.GeneratedFile {
