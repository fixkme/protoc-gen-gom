...
func (m *MTimeLimitTotalRechargeInfo) String() string {
	...
	fmt.Fprintf(&strBuilder, "%v", m.activityId)
	strBuilder.WriteString(", ")
	strBuilder.WriteString("userGroup:")
	fmt.Fprintf(&strBuilder, "%v", m.userGroup)
	strBuilder.WriteString(", ")
	strBuilder.WriteString("totalRecharge:")
	fmt.Fprintf(&strBuilder, "%v", m.totalRecharge)
	strBuilder.WriteString(", ")
	...
	fmt.Fprintf(&strBuilder, "%v", m.isOver)
	strBuilder.WriteString(", ")
	strBuilder.WriteString("dailyFlag:")
	fmt.Fprintf(&strBuilder, "%v", m.dailyFlag)
	strBuilder.WriteString(", ")
	strBuilder.WriteString("totalDay:")
	fmt.Fprintf(&strBuilder, "%v", m.totalDay)
	strBuilder.WriteString(", ")
	strBuilder.WriteString("lastResetTime:")
	fmt.Fprintf(&strBuilder, "%v", m.lastResetTime)
	strBuilder.WriteString("}")
